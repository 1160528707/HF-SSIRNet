...
def parse_agrs():
    ...
    parser.add_argument('--image_dir', type=str, default=r'E:\AAApaper\part2\data\final_data\his\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r"E:\AAApaper\part2\data\final_data\his\imageid_to_report.json",
                        help='the path to the directory containing the data.')
    ...
    parser.add_argument('--visual_extractor', type=str, default='vig_b_224', help='the visual extractor to be used.')
    ...
    parser.add_argument('--mode', type=str, default='train', help='t.')
    ...
    parser.add_argument('--save_dir', type=str, default=r'E:\AAApaper\part2\model\CMN_VIG_QL\his', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default=r'E:\AAApaper\part2\model\CMN_VIG_QL\his', help='the patch to save the results of experiments.')
